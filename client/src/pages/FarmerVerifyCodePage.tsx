...
const FarmerVerifyCodePage: React.FC = () => {
  ...
  useEffect(() => {
    // Check if farmerId is in URL params (from password reset flow)
    ...
    // Otherwise, check local storage (from registration flow)
    ...
    // If no farmerId found, redirect to registration
