...
import { getUser, loginUser, logoutUser, registerUser, verifyOtp, forgotPassword, resetPassword, refreshToken, resendVerificationCode } from "../controllers/authUser.controller.js";
...
router.post("/resend-verification",validate(forgotPasswordSchema),resendVerificationCode);
